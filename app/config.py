...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql+asyncpg://adminuser:CrisantoUpíicsa2021@reservabar-postgres-server.postgres.database.azure.com:5432/postgres?sslmode=require" # Usamos SQLite por defecto para desarrollo local fácil
